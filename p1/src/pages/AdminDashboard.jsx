...
const AdminDashboard = () => {
  ...
  const fetchPending = useCallback(async () => {
    try {
      ...
      const res = await fetch('https://mentalhealth-project-sih-mitr.onrender.com/api/resiliency/pending');
      if (res.ok) {
  ...
  const handleModeration = async (id, decision) => {
    ...
    try {
      const res = await fetch(`https://mentalhealth-project-sih-mitr.onrender.com/api/resiliency/moderate/${id}`, {
        method: 'PATCH',
