...
const HomePage = () => {
  ...
  const loadProfiles = async () => {
    try {
      ...
      const response = await fetch('https://https://mentalhealth-project-sih-mitr.onrender.com/api/resiliency/shared');
  ...
  const submitResiliency = async () => {
    ...
    try {
      const response = await fetch('https://https://mentalhealth-project-sih-mitr.onrender.com/api/resiliency/opt-in', {
        method: 'POST',
